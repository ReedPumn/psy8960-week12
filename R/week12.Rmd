...
# This line of code identifies which indices in our DTM are blank. I tried to preprocess softly to prevent problems here.
empty_indices <- which(io_dtm$dimnames$Terms == 0, arr.ind = TRUE)
# Print the empty indices. Because none were printed, no empty indices exist.
print(empty_indices)
```